...
else f[d]&&"object"==typeof c?f[d]=a.extend(f[d]||{},c[d]):f[d]=c[d];return f},function(a,b,c,d,e,f){var g,h=a.createElement("div").children;try{[].push.apply([],h)}catch(i){g=!0}return g=g||"function"==typeof h||a.documentMode<9,g&&(f=b.i[d="prototype"],b.i=function(g,h){for(e=g?g&&g.nodeType||g==window?[g]:"string"==typeof g?/</.test(g)?((c=a.createElement("div")).innerHTML=g,c.children):(h&&b(h)[0]||a).querySelectorAll(g):!/f/.test(typeof g)||g[0]||g[0].nodeType?g:/c/.test(a.readyState)?g():!function r(b){/in/(a.readyState)?setTimeout(r,9,b):b()}(g):f,d=[],c=e?e.length:0;c--;d[c]=e[c]);f.push.apply(this,d)},b.i[d]=f,f.is=function(a){var b,c=this[0],d=c.parentNode.querySelectorAll(a);for(b=0;b<d.length;b++)if(d[b]===c)return!0;return!1}),b}(document,a),a}),function(a,b){"function"==typeof define&&define.amd?define("matreshka_dir/dollar-lib",["matreshka_dir/balalaika-extended"],b):a.__DOLLAR_LIB=b(a.$b)}(this,function(a){var b,c="on off is hasClass addClass removeClass toggleClass add not find".split(/\s+/),d="function"==typeof $?$:null,e=!0;

if(d){for(b=0;b<c.length;b++)if(!d.prototype[c[b]]){e=!1;break}d.parseHTML||(e=!1)}else e=!1;return e?d:a}),function(a,b){"function"==typeof define&&define.amd?define("matreshka_dir/binders",b):a.__MK_BINDERS=b()}(this,function(a){var b,c=function(a){return{on:null,getValue:null,setValue:a}};return b={innerHTML:function(){return c(function(a){this.innerHTML=null===a?"":a+""})},className:function(a){var b=!a.indexOf("!");return b&&(a=a.replace("!","")),c(function(c){this.classList.toggle(a,b?!c:!!c)})},property:function(a){return c(function(b){this[a]=b})},attribute:function(a){return c(function(b){this.setAttribute(a,b)})},textarea:function(){return b.input("text")},progress:function(){return b.input()},input:function(a){var b;switch(a){case"checkbox":return{on:"click keyup",getValue:function(){return this.checked},setValue:function(a){this.checked=a}};case"radio":return{on:"click keyup",getValue:function(){return this.value},setValue:function(a){this.checked=this.value==a}};case"submit":
case"button":case"image":case"reset":return{};case"hidden":b=null;break;case"file":b="change";break;case"text":case"password":b=8==document.documentMode?"keyup paste":"input";break;default:b="input"}return{on:b,getValue:function(){return this.value},setValue:function(a){this.value!=a&&(this.value=a)}}},select:function(a){var b;return a?{on:"change",getValue:function(){return[].slice.call(this.options).filter(function(a){return a.selected}).map(function(a){return a.value})},setValue:function(a){for(a="string"==typeof a?[a]:a,b=this.options.length-1;b>=0;b--)this.options[b].selected=~a.indexOf(this.options[b].value)}}:{on:"change",getValue:function(){return this.value},setValue:function(a){var c,d=this;if(d.value=a,!a)for(c=d.options,b=c.length-1;b>=0;b--)c[b].value||(c[b].selected=!0)}}},visibility:function(a){return a="undefined"==typeof a?!0:a,c(function(b){this.style.display=a?b?"":"none":b?"none":""})}}}),function(a,b){"function"==typeof define&&define.amd?define("matreshka_dir/matreshka-core",["xclass","balalaika","matreshka_dir/dollar-lib","matreshka_dir/binders"],b):a.MK=a.Matreshka=b(a.Class,a.$b,a.__DOLLAR_LIB,a.__MK_BINDERS);

}(this,function(a,b,c,d){if(!a)throw Error("Class function is missing");if(![].forEach)throw Error("Internet Explorer 8 requires to use es5-shim: https://github.com/es-shims/es5-shim");var e={list:{},add:function(a){a.node&&("function"==typeof a.on?a.on.call(a.node,a.handler):c(a.node).on(a.on.split(/\s/).join(".mk ")+".mk",a.handler)),(this.list[a.instance.__id]=this.list[a.instance.__id]||[]).push(a)},remove:function(a){var b,d,e=this.list[a.instance.__id];if(e)for(d=0;d<e.length;d++)b=e[d],b.node===a.node&&(b.mkHandler&&a.instance._off("_runbindings:"+a.key,b.mkHandler),c(a.node).off(b.on+".mk",b.handler),this.list[a.instance.__id].splice(d--,1))}},f=[].slice,g=function(a){return a.trim?a.trim():a.replace(/^\s+|\s+$/g,"")},h=function(a,b){var d,e,f,h=c();return b.replace(/:sandbox/g,":bound(sandbox)").split(",").forEach(function(b){(d=/:bound\(([^(]*)\)(.*)/.exec(g(b)))?(e=a.$bound(d[1]),(f=g(d[2]))?0==f.indexOf(">")?k(e,function(a){var b=i.randomString();a.setAttribute(b,b),h=h.add(c("["+b+'="'+b+'"]'+f,a)),
a.removeAttribute(b)}):h=h.add(e.find(f)):h=h.add(e)):h=h.add(b)}),h},i=a({isMK:!0,isMKInitialized:!1,on:function(a,b,c,d,e){var f,h,i=this._initMK();if("object"==typeof a&&!(a instanceof Array)){for(h in a)a.hasOwnProperty(h)&&i.on(h,a[h],b,c);return i}if(!b)throw Error('callback is not function for event(s) "'+a+'"');for(a=a instanceof Array?a:g(a).replace(/\s+/g," ").split(/\s(?![^(]*\))/g),"boolean"!=typeof c&&"undefined"!=typeof c&&(f=d,d=c,c=f),h=0;h<a.length;h++)i._on(a[h],b,d,e);return c===!0&&b.call(d||i,{triggeredOnInit:!0}),i},onDebounce:function(a,b,c,d,e,f){var g;return"number"!=typeof c&&(f=e,e=d,d=c,c=0),g=i.debounce(b,c),g._callback=b,this.on(a,g,d,e,f)},_on:function(a,b,d,e){var f,g,h,i,j,k,l,m,n,o,p,q,r=a.indexOf("@"),s=this._initMK(),t=d||s,u=/^(.*?)\((.*)\)/;return~r?(k=a.slice(0,r),a=a.slice(r+1),l=function(c){var e,f=s[k];f&&f.isMK&&(e=function(a){a&&a["private"]||b.apply(this,arguments)},e._callback=b,f._on(a,e,t)),c&&c.previousValue&&c.previousValue.isMK&&c.previousValue._off(a,b,d);

},l._callback=b,s._on("change:"+k,l,s,a),l()):(a=a.replace("::(","::sandbox("),f=a.replace(/\(.+\)/,""),i=s.__events[f]||(s.__events[f]=[]),j={callback:b,context:d,ctx:t,xtra:e},i.some(function(a){return a.callback==j.callback&&a.callback._callback==j.callback&&a.context==j.context})||(i.push(j),a.indexOf("change:")||s._defineSpecial(a.replace("change:","")),p=a.split("::"),q=p[0],k=p[1],k&&((h=u.exec(k))&&(g=j.selector=h[2],k=h[1]),o=function(a){var d,e,f=this,h=c(f),i=function(){b.call(t,{self:s,node:f,$nodes:h,key:k,domEvent:a,originalEvent:a.originalEvent||a,preventDefault:function(){a.preventDefault()},stopPropagation:function(){a.stopPropagation()},which:a.which,target:a.target})};g?(e="x"+String(Math.random()).split(".")[1],f.setAttribute(e,e),d="["+e+'="'+e+'"] '+g,c(a.target).is(d+","+d+" *")&&i(),f.removeAttribute(e)):i()},m=function(a){var b=a&&a.$nodes||s.__special[k]&&s.__special[k].$nodes,c=q+"."+s.__id+k;b&&b.on(c,o)},n=function(a){a.$nodes&&a.$nodes.off(q+"."+s.__id+k,o);

},m._callback=n._callback=b,s._on("bind:"+k,m),m(),s._on("unbind:"+k,n)))),s},once:function(a,b,c){if(!b)throw Error('callback is not function for event "'+a+'"');var d,e=this._initMK();for(a=a.split(/\s/),d=0;d<a.length;d++)!function(a){var d=function(a){var b,c=!1;return function(){return c?b:(c=!0,b=a.apply(this,arguments),a=null,b)}}(b);d._callback=b,e._on(a,d,c)}(a[d]);return this},off:function(a,b,c){var d,e=this._initMK();if("object"==typeof a&&!(a instanceof Array)){for(d in a)a.hasOwnProperty(d)&&e.off(d,a[d],b);return e}if(!a&&!b&&!c)return e.events={},e;for(a=g(a).replace(/\s+/g," ").split(/\s(?![^(]*\))/g),d=0;d<a.length;d++)e._off(a[d],b,c);return e},_off:function(a,b,c){var d,e,f,g,h,i,j,k,l,m=a.indexOf("@"),n=this._initMK(),o=/^(.*?)\((.*)\)/;if(~m){if(i=a.slice(0,m),a=a.slice(m+1),b)n._off("change:"+i,b,c);else for(h=n.__events["change:"+i]||[],l=0;l<h.length;l++)h[l].xtra===a&&n._off("change:"+i,h[l].callback);n[i]&&n[i].isMK&&n[i]._off(a,b,c)}else if(h=n.__events[a]){if(n.__events[a]=f=[],
b||c)for(l=0;l<h.length;l++)g=h[l],(b&&b!==g.callback&&b!==g.callback._callback||c&&c!==g.context)&&f.push(g);f.length||delete n.__events[a],j=a.split("::"),k=j[0],i=j[1],i&&n.__special[i]&&((e=o.exec(i))&&(d=g.selector=e[2],i=e[1]),n.__special[i].$nodes.off(k+"."+n.__id+i),n._off("bind:"+i,b),n._off("unbind:"+i,b))}return n},trigger:function(a){var b,c,d=this._initMK();if(a)for(b=f.call(arguments),a=a.split(/\s/),c=0;c<a.length;c++)b=b.slice(),b[0]=a[c],d._trigger.apply(d,b);return d},_trigger:function(a){var b,c,d=this._initMK(),e=d.__events[a];return a&&e&&(b=f.call(arguments,1),c=function(a,b){for(var c,d=-1,e=a.length;++d<e;)(c=a[d]).callback.apply(c.ctx,b||[])},c(e,b)),d},bindNode:function(a,b,c,d,f){var g,h,k,l,m=this._initMK(),n="undefined"==typeof m[a];if(a instanceof Array){for(k=0;k<a.length;k++)m.bindNode(a[k][0],a[k][1],a[k][2]||d,b);return m}if("string"==typeof a&&(h=a.split(/\s/),h.length>1)){for(k=0;k<h.length;k++)m.bindNode(h[k],b,c,d);return m}if("object"==typeof a){for(k in a)a.hasOwnProperty(k)&&m.bindNode(k,a[k],b,c,d);

return m}if(d=d||{},l=m._defineSpecial(a),g=m._getNodes(b),!g.length){if(f)return m;throw Error('Binding error: node is missing for key "'+a+'"')}return l.$nodes=l.$nodes.add(g),m.$nodes[a]=l.$nodes,m.nodes[a]=l.$nodes[0],"sandbox"==a&&(m.$sandbox=l.$nodes,m.sandbox=l.$nodes[0]),i.each(g,function(b){var f,h=null!==c?j("sandbox"==a?{}:i.lookForBinder(b)||{},c):{},k={self:m,key:a,$nodes:g,node:b};h.initialize&&h.initialize.call(b,j({value:l.value},k)),h.setValue&&(f=function(c){var d=m[a];c&&c.changedNode==b&&c.onChangeValue==d||h.setValue.call(b,d,j({value:d},k))},m._on("_runbindings:"+a,f),!n&&f()),n&&h.getValue&&d.assignDefaultValue!==!1&&m.set(a,h.getValue.call(b,k),j({fromNode:!0},d)),h.getValue&&h.on&&e.add({node:b,on:h.on,instance:m,key:a,mkHandler:f,handler:function(c){var d=m[a],e=h.getValue.call(b,j({value:d,domEvent:c,originalEvent:c.originalEvent||c,preventDefault:function(){c.preventDefault()},stopPropagation:function(){c.stopPropagation()},which:c.which,target:c.target},k));
e!==d&&m.set(a,e,{fromNode:!0,changedNode:b,onChangeValue:e})}})}),d.silent||m._trigger("bind:"+a,j({key:a,$nodes:g,node:g[0]||null},d)),m},bindOptionalNode:function(a,b,c,d){var e=this;return"object"==typeof a?e.bindNode(a,b,c,!0):e.bindNode(a,b,c,d,!0),e},unbindNode:function(a,b,c){var d,f,g,h=this._initMK(),k=typeof a,l=h.__special[a];if(a instanceof Array){for(g=0;g<a.length;g++)c=b,h.unbindNode(a[g][0],a[g][1]||c,c);return h}if("string"==k&&(f=a.split(/\s/),f.length>1)){for(g=0;g<f.length;g++)h.unbindNode(f[g],b,c);return h}if(null===a){for(a in h.__special)h.__special.hasOwnProperty(a)&&h.unbindNode(a,b,c);return h}if("object"==k){for(g in a)a.hasOwnProperty(g)&&h.unbindNode(g,a[g],b);return h}return b?l?(d=h._getNodes(b),i.each(d,function(a,b){e.remove({node:a,instance:h}),l.$nodes=l.$nodes.not(a)}),h.$nodes[a]=l.$nodes,h.nodes[a]=l.$nodes[0]||null,"sandbox"==a&&(h.sandbox=l.$nodes[0]||null,h.$sandbox=l.$nodes),c&&c.silent||h._trigger("unbind:"+a,j({key:a,$nodes:d,node:d[0]||null
},c)),h):h:l&&l.$nodes?h.unbindNode(a,l.$nodes,c):h},boundAll:function(a){var b,d,e,f=this._initMK(),g=f.__special;if(a=a?a:"sandbox",b="string"==typeof a?a.split(/\s/):a,b.length<=1)return b[0]in g?g[b[0]].$nodes:c();for(d=c(),e=0;e<b.length;e++)d=d.add(g[b[e]].$nodes);return d},$bound:function(a){return this.boundAll(a)},bound:function(a){var b,c,d=this._initMK(),e=d.__special;if(a=a?a:"sandbox",b="string"==typeof a?a.split(/\s/):a,b.length<=1)return b[0]in e?e[b[0]].$nodes[0]||null:null;for(c=0;c<b.length;c++)if(b[c]in e&&e[b[c]].$nodes.length)return e[b[c]].$nodes[0];return null},selectAll:function(a){var b=this._initMK();return/:sandbox|:bound\(([^(]*)\)/.test(a)?h(b,a):b.$sandbox.find(a)},$:function(a){return this.selectAll(a)},select:function(a){return this.selectAll(a)[0]||null},_getNodes:function(a){return"string"==typeof a&&!/</.test(a)&&/:sandbox|:bound\(([^(]*)\)/.test(a)?h(this._initMK(),a):c(a)},_defineSpecial:function(a){var b=this._initMK(),d=b.__special[a];return d||(d=b.__special[a]={
$nodes:c(),value:b[a],getter:function(){return d.value},setter:function(c){b.set(a,c,{fromSetter:!0})},mediator:null},Object.defineProperty(b,a,{configurable:!0,get:function(){return d.getter.call(b)},set:function(a){d.setter.call(b,a)}})),d},eq:function(a){return"object"==typeof a&&null!==a&&this.__id==a.__id},defineGetter:function(a,b){var c,d,e=this._initMK();if("object"==typeof a){for(d in a)a.hasOwnProperty(d)&&e.defineGetter(d,a[d]);return e}return c=e._defineSpecial(a),c.getter=function(){return b.call(e,{value:c.value,key:a,self:e})},e},defineSetter:function(a,b){var c,d=this._initMK();if("object"==typeof a){for(c in a)a.hasOwnProperty(c)&&d.defineSetter(c,a[c]);return d}return d._defineSpecial(a).setter=function(c){return b.call(d,c,{value:c,key:a,self:d})},d},mediate:function(a,b){var c,d,e=this._initMK(),f=typeof a;if("object"==f&&!(a instanceof Array)){for(c in a)a.hasOwnProperty(c)&&e.mediate(c,a[c]);return e}for(a="string"==f?a.split(/\s/):a,c=0;c<a.length;c++)(function(a){
d=e._defineSpecial(a),d.mediator=function(c){return b.call(e,c,d.value,a,e)},e.set(a,d.mediator(d.value),{fromMediator:!0})})(a[c]);return e},linkProps:function(a,b,c,d){var e,f,g,h,i,b="string"==typeof b?b.split(/\s/):b,k=function(d){var k=[],m=d._protect=d._protect||d.key+this.__id;if(m!==a+l.__id){if("object"==typeof b[0])for(h=0;h<b.length;h+=2)for(e=b[h],g="string"==typeof b[h+1]?b[h+1].split(/\s/):b[h+1],i=0;i<g.length;i++)k.push(e[g[i]]);else for(h=0;h<b.length;h++)f=b[h],e=l,k.push(e[f]);l.set(a,c.apply(l,k),j({},d,{fromDependency:!0}))}},l=this._initMK();if(c=c||function(a){return a},"object"==typeof b[0])for(h=0;h<b.length;h+=2)for(e=b[h]._initMK(),g="string"==typeof b[h+1]?b[h+1].split(/\s/):b[h+1],i=0;i<g.length;i++)e._defineSpecial(g[i]),e._on("_rundependencies:"+g[i],k);else for(h=0;h<b.length;h++)f=b[h],e=this,e._defineSpecial(f),e._on("_rundependencies:"+f,k);return d!==!1&&k.call("object"==typeof b[0]?b[0]:this,{key:"object"==typeof b[0]?b[1]:b[0]}),this},get:function(a){
return this[a]},set:function(a,b,c){var d,e,f,g,h=this,i=typeof a,k=Number.isNaN||function(a){return"number"==typeof a&&k(a)};if("undefined"==i)return h;if("object"==i){for(g in a)a.hasOwnProperty(g)&&h.set(g,a[g],b);return h}return h.__special&&h.__special[a]?(d=h.__special[a],e=d.value,c=c||{},f=!d.mediator||b===e||c.skipMediator||c.fromMediator?b:d.mediator.call(h,b,e,a,h),d.value=f,(f!==e||c.force||c.forceHTML||f!==b&&!k(f))&&(c=j({},c,{value:f,previousValue:e,key:a,node:d.$nodes[0]||null,$nodes:d.$nodes,self:h}),c.silentHTML||h._trigger("_runbindings:"+a,c)),f===e&&!c.force||c.silent||h._trigger("change:"+a,c)._trigger("change",c),f===e&&!c.force&&!c.forceHTML||c.skipLinks||h._trigger("_rundependencies:"+a,c),h):(h[a]=b,h)},remove:function(a,b){var c,d,e=this._initMK(),f=String(a).split(/\s/);for(b=j({keys:f},b),d=0;d<f.length;d++)if(c=f[d]in e){b.key=f[d],b.value=e[f[d]],e.unbindNode(f[d])._off("change:"+f[d]),delete e.__special[f[d]];try{delete e[f[d]]}catch(g){}b&&b.silent||e._trigger("delete",b)._trigger("delete:"+f[d],b);

}return e},define:function(a,b){var c=this;if("object"==typeof a){for(var d in a)c.define(d,a[d]);return c}return Object.defineProperty(c,a,b),c},delay:function(a,b,c){var d=this;return"object"==typeof b&&(c=b,b=0),setTimeout(function(){a.call(c||d)},b||0),d},_parseBindings:function(a){var b=this._initMK(),d="string"==typeof a?i.$.parseHTML(a.replace(/^\s+|\s+$/g,"")):c(a),e=d.find("*").add(d);return i.each(e,function(a){!function f(a){"TEXTAREA"!==a.tagName&&i.each(a.childNodes,function(b){var c,d=b.previousSibling;3==b.nodeType&&~b.nodeValue.indexOf("{{")?(c=b.nodeValue.replace(/{{([^}]*)}}/g,'<mk-bind mk-html="$1"></mk-bind>'),d?d.insertAdjacentHTML("afterend",c):a.insertAdjacentHTML("afterbegin",c),a.removeChild(b)):1==b.nodeType&&f(b)})}(a)}),e=d.find("*").add(d),i.each(e,function(a){var c=a.getAttribute("mk-html");c&&(b.bindNode(c,a,i.binders.innerHTML()),a.removeAttribute("mk-html")),i.each(a.attributes,function(c){var d,e,f=g(c.value),h=c.name;~f.indexOf("{{")&&(d=f.match(/{{[^}]*}}/g).map(function(a){
return a.replace(/{{(.*)}}/,"$1")}),1==d.length&&/^{{[^}]*}}$/g.test(f)?e=d[0]:(e=i.randomString(),b.linkProps(e,d,function(){var a=f;return d.forEach(function(c){a=a.replace(new RegExp("{{"+c+"}}","g"),b[c])}),a})),("value"==h&&"checkbox"!=a.type||"checked"==h&&"checkbox"==a.type)&&i.lookForBinder(a)?b.bindNode(e,a):b.bindNode(e,a,i.binders.attribute(h)))})},b),d},_initMK:function(){var a=this;return a.isMKInitialized||j(a,{isMKInitialized:!0,Matreshka:i,sandbox:null,__id:"mk"+i.randomString(),__events:{},__special:{},$nodes:{},nodes:{}}),a},toString:function(){return"[object Matreshka]"},constructor:function Matreshka(){this._initMK()},getAnswerToTheUltimateQuestionOfLifeTheUniverseAndEverything:function(){this.delay(function(){alert(42)},236682e12)}}),j=i.extend=function(a,b){var c,d;if(a)for(c=1;c<arguments.length;c++)if(b=arguments[c])for(d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);return a},k=i.each=function(a,b,c){if(a){if("length"in a)[].forEach.call(a,b,c);else for(var d in a)a.hasOwnProperty(d)&&b.call(c,a[d],d,a);

return a}};return j(i,{version:"dev",binders:d,defaultBinders:[],Class:a,$:c,$b:b,useAs$:function(a){return i.$=c=a},isXDR:a.isXDR,noop:function(){},debounce:function(a,b,c){var d;return"number"!=typeof b&&(c=b,b=0),function(){var e=arguments,f=this;clearTimeout(d),d=setTimeout(function(){a.apply(c||f,e)},b||0)}},randomString:function(){return((new Date).getTime()-new Date(2013,4,3).getTime()).toString(36)+Math.floor(1679616*Math.random()).toString(36)},lookForBinder:function(a){var b,c,d=i.defaultBinders;for(c=0;c<d.length;c++)if(b=d[c].call(a,a))return b},to:function to(a){var b,c;if("object"==typeof a)if("length"in a){for(b=[],c=0;c<a.length;c++)b[c]=to(a[c]);b=(new i.Array).recreate(b)}else{b={};for(c in a)a.hasOwnProperty(c)&&(b[c]=to(a[c]));b=new i.Object(b)}else b=a;return b}}),i.defaultBinders.push(function(a){var b,c=a.tagName;return"INPUT"==c?b=d.input(a.type):"TEXTAREA"==c?b=d.textarea():"SELECT"==c?b=d.select(a.multiple):"PROGRESS"==c&&(b=d.progress()),b}),i}),function(a,b){
"function"==typeof define&&define.amd?define("matreshka_dir/matreshka-object",["matreshka_dir/matreshka-core"],b):b(a.MK)}(this,function(a){if(!a)throw new Error("Matreshka is missing");var b,c={"extends":a,isMKObject:!0,renderer:null,constructor:function MatreshkaObject(a){this.jset(a)},keys:function(){var a,b=this,c=[];for(a in b._keys)b._keys.hasOwnProperty(a)&&c.push(a);return c},_initMK:function(){var b=this;return b.isMKInitialized?b:(a.Object.parent._initMK(b,arguments),b.set("_keys",{})._on("delete",function(a){a&&a.silent||b._trigger("modify",a)})._on("change",function(a){a&&a.key in b._keys&&!a.silent&&b._trigger("modify",a)}))},_on:function(b,c,d,e){var f,g=this._initMK();return 0==b.indexOf("@")?(b=b.slice(1),f=function(a){var e=g[a.key];e&&e.isMK&&a&&a.key in g._keys&&e._on(b,c,d||g)},g.each(function(a){a&&a.isMK&&a._on(b,c,d||g)},g),f._callback=c,g._on("change",f,g,b)):a.prototype._on.call(g,b,c,d,e),this},_off:function(b,c,d){var e=this._initMK();if(0==b.indexOf("@")){if(b=b.slice(1),
c)e.off("change",c,d);else{events=e.__events.change||[];for(var f=0;f<events.length;f++)events[f].xtra==b&&e.off("change",events[f].callback)}e.each(function(a){a.isMK&&a.off(b,c,d)},e)}else a.prototype._off.call(e,b,c,d);return this},hasOwnProperty:function(a){return this._initMK()._keys.hasOwnProperty(a)},toObject:function(){var a,b=this._initMK(),c={},d=b._keys;for(a in d)d.hasOwnProperty(a)&&(c[a]=b[a]);return c},toNative:function(){return this.toObject()},toJSON:function(){var a=this._initMK(),b={},c=a._keys;for(var d in c)c.hasOwnProperty(d)&&(b[d]=a[d]&&a[d].toJSON?a[d].toJSON():a[d]);return b},keyOf:function(a){var b,c=this._initMK(),d=c._keys;for(b in d)if(d.hasOwnProperty(b))if(a&&a.isMK){if(a.eq(c[b]))return b}else if(a===c[b])return b;return null},jset:function(a,c,d){var e=this._initMK(),f=typeof a;if("undefined"==f)return e;if("object"==f){a=a.toJSON?a.toJSON():a;for(b in a)e.jset(b,a[b],c);return e}return e._keys[a]=1,e._defineSpecial(a),e.set(a,c,d)},remove:function(b,c){
return this.removeDataKeys(b),a.Object.parent.remove(this,b,c)},addDataKeys:function(a){var c=this._initMK();if(!arguments.length)return c;for(a=arguments.length>1?arguments:a instanceof Array?a:String(a).split(/\s/),b=0;b<a.length;b++)c._keys[a[b]]=1,c._defineSpecial(a[b]);return c},removeDataKeys:function(a){var c=this._initMK();if(!arguments.length)return c;for(a=arguments.length>1?arguments:a instanceof Array?a:String(a).split(/\s/),b=0;b<a.length;b++)delete c._keys[a[b]];return c},each:function(a,b){var c,d=this._initMK();for(c in d._keys)d._keys.hasOwnProperty(c)&&a.call(b,d[c],c,d);return d}};return c["undefined"!=typeof Symbol?Symbol.iterator:"@@iterator"]=function(){var a=this,b=a.keys(),c=0;return{next:function(){return c>b.length-1?{done:!0}:{done:!1,value:a[b[c++]]}}}},a.Object=a.Class(c)}),function(a,b){"function"==typeof define&&define.amd?define("matreshka_dir/matreshka-array",["matreshka_dir/matreshka-core"],b):b(a.MK)}(this,function(a){if(!a)throw new Error("Matreshka is missing");

var b=Array.prototype,c=b.slice,d={silent:!0,dontRender:!0,skipMediator:!0},e=function(a,b,c,d){if(a.length!=b.length)return!1;for(c=0,d=a.length;d>c;c++)if(a[c]&&a[c].isMK?!a[c].eq(b[c]):a[c]!==b[c])return!1;return!0},f=a.isXDR?function(a){var b,c,d=this,e=a&&a.isMK;for(b=0;b<d.length;b++)if(c=d[b],e?a.eq(c):a===c)return b;return-1}:b.indexOf,g=a.isXDR?function(a){var b,c,d=this,e=a&&a.isMK;for(b=d.length-1;b>=0;b--)if(c=d[b],e?a.eq(c):a===c)return b;return-1}:b.lastIndexOf,h=function(a,b,c){if(a.__events.addone)for(c=0;c<b.length;c++)a._trigger("addone",{self:a,added:b[c]})},i=function(a,b,c){if(a.__events.removeone)for(c=0;c<b.length;c++)a._trigger("removeone",{self:a,removed:b[c]})},j=function(f,g){var j;switch(f){case"forEach":return function(){var c=this;return b[f].apply(a.isXDR?c.toArray():c,arguments),c};case"map":case"filter":case"slice":return function(){var c=this;return(new a.Array).recreate(b[f].apply(a.isXDR?c.toArray():c,arguments),d)};case"every":case"some":case"reduce":
case"reduceRight":case"toString":case"join":return function(){var c=this;return b[f].apply(a.isXDR?c.toArray():c,arguments)};case"sort":case"reverse":return function(){var h=this,i=arguments,j=c.call(i,0,g?-1:i.length),k=g?i[i.length-1]||{}:{},l=h.toArray(),m=b[f].apply(l,j);return e(h,l)||(h.recreate(l,d),k=a.extend({returns:m,args:j,originalArgs:c.call(i),method:f,self:h,added:[],removed:[]},k),k.silent||h._trigger(f,k)._trigger("modify",k),k.dontRender||h.processRendering(k)),h};case"push":case"pop":case"unshift":case"shift":return function(){var k,l,m,n=this,o=arguments,p=c.call(o,0,g?-1:o.length),q=g?o[o.length-1]||{}:{},r=n.toArray();if(!q.skipMediator&&"function"==typeof n._itemMediator&&("unshift"==f||"push"==f))for(j=0;j<p.length;j++)p[j]=n._itemMediator.call(n,p[j],j);return k=b[f].apply(r,p),e(n,r)||(n.recreate(r,d),q=a.extend({returns:k,args:p,originalArgs:c.call(o),method:f,self:n,added:l="push"==f||"unshift"==f?p:[],removed:m="pop"==f||"shift"==f?[k]:[]},q),q.silent||(n._trigger(f,q),
l.length&&(n._trigger("add",q),h(n,l)),m.length&&(n._trigger("remove",q),i(n,m)),n._trigger("modify",q)),q.dontRender||n.processRendering(q)),k};case"splice":return function(){var k,l,m,n=this,o=arguments,p=c.call(o,0,g?-1:o.length),q=g?o[o.length-1]||{}:{},r=n.toArray();if(!q.skipMediator&&"function"==typeof n._itemMediator)for(j=2;j<p.length;j++)p[j]=n._itemMediator.call(n,p[j],j);return k=b[f].apply(r,p),e(n,r)||(n.recreate(r,d),q=a.extend({returns:k,args:p,originalArgs:c.call(o),method:f,self:n,added:l=c.call(p,2),removed:m=k},q),q.silent||(n._trigger(f,q),l.length&&(n._trigger("add",q),h(n,l)),m.length&&(n._trigger("remove",q),i(n,m)),n._trigger("modify",q)),q.dontRender||n.processRendering(q)),(new a.Array).recreate(k,d)}}},k={"extends":a,isMKArray:!0,length:0,itemRenderer:null,renderIfPossible:!0,useBindingsParser:!1,Model:null,constructor:function MatreshkaArray(a){var b,c=this._initMK(),d=arguments.length;if(1==d&&"number"==typeof a)c.length=a;else{for(b=0;d>b;b++)c[b]=arguments[b];

c.length=arguments.length}},mediateItem:function(a){var b,c=this;for(c._itemMediator=a,b=0;b<c.length;b++)c[b]=a.call(c,c[b],b);return c},_on:function(b,c,d,e){var f,g=this._initMK();return 0==b.indexOf("@")?(b=b.slice(1),f=function(a){(a&&a.added?a.added:g).forEach(function(a){a&&a.isMK&&a._on(b,c,d||g)})},f._callback=c,g._on("add",f,g,b),f.call(d||g)):a.prototype._on.call(g,b,c,d,e),g},_off:function(b,c,d){var e,f,g=this._initMK();if(0==b.indexOf("@")){if(b=b.slice(1),c)g.off("add",c,d);else for(e=g.__events.add||[],f=0;f<e.length;f++)e[f].xtra==b&&g.off("add",e[f].callback);g.forEach(function(a){a.isMK&&a.off(b,c,d)},g)}else a.prototype._off.call(g,b,c,d);return g},recreate:function(b,c){b=b||[];var d,e,g,j,k,l=this,m=l.length-b.length,n=l.toArray();if(c=c||{},l._itemMediator&&!c.skipMediator){for(d=[],e=0;e<b.length;e++)d[e]=l._itemMediator.call(l,b[e],e);b=d}for(e=0;e<b.length;e++)l[e]=b[e];for(e=0;m>e;e++)l.remove(e+b.length,{silent:!0});return l.length=b.length,c.silent&&c.dontRender?l:(k=l.toArray(),
j=n.length?n.filter(function(a){return!~f.call(k,a)}):[],g=k.length?k.filter(function(a){return!~f.call(n,a)}):[],c=a.extend({added:g,removed:j,was:n,now:k,method:"recreate",self:l},c),c.silent||(g.length&&(l._trigger("add",c),h(l,g)),j.length&&(l._trigger("remove",c),i(l,j)),(g.length||j.length)&&l._trigger("recreate",c)._trigger("modify",c)),c.dontRender||l.processRendering(c),l)},toArray:function(){var a,b,d=this;try{return c.call(d)}catch(e){for(a=[],b=0;b<d.length;b++)a[b]=d[b];return a}},toNative:function(){return this.toArray()},_initMK:function(){var b=this;return b.isMKInitialized?b:a.prototype._initMK.call(b).on("change:Model",function(){var a=b.Model;a&&b.mediateItem(function(c){return c&&c.isMK&&c.instanceOf(a)?c:new a(c&&c.toJSON?c.toJSON():c,b)})},!0)},_renderOne:function(b,c){var d,e,f=this,g=f.__id,h=b.renderer||f.itemRenderer,i=h===b.renderer?b:f,j=b.bound(g);if(b[g]||(b[g]=f),c.moveSandbox&&(j=b.bound("sandbox"))&&b.bindNode(g,j),!j){if("function"==typeof h&&(h=h.call(i,b)),
"string"!=typeof h||~h.indexOf("<")||~h.indexOf("{{"))e=h;else{if(e=i._getNodes(h),!(e=e&&e[0]))throw Error("renderer node is missing: "+h);e=e.innerHTML}d=f.useBindingsParser?b._parseBindings(e):"string"==typeof e?a.$.parseHTML(e.replace(/^\s+|\s+$/g,"")):a.$(e),b.bindRenderedAsSandbox!==!1&&d.length&&b.bindNode("sandbox",d),b.bindNode(g,d),b._trigger("render",{node:d[0],$nodes:d,self:b,parentArray:f}),j=d[0]}return j},processRendering:function(a){var b,c,d=this,e=d.__id,f=f=d.bound("container")||d.bound(),g=function(a){if(a&&a.isMK){var b=a.bound(e);return a.remove(e,{silent:!0}),b}},h=function(b){return b&&b.isMK&&d.renderIfPossible&&f&&!a.dontRender&&(d.itemRenderer||b&&b.renderer)&&d._renderOne(b,a)};switch(a.method){case"push":for(c=d.length-a.added.length;c<d.length;c++)(b=h(d[c]))&&f.appendChild(b);break;case"unshift":for(c=a.added.length-1;c+1;c--)(b=h(d[c]))&&(f.children?f.insertBefore(b,f.firstChild):f.appendChild(b));break;case"pull":case"pop":case"shift":for(c=0;c<a.removed.length;c++)(b=g(a.removed[c]))&&f.removeChild(b);

break;case"sort":case"reverse":for(c=0;c<d.length;c++)(b=d[c].bound(e))&&f.appendChild(b);break;case"rerender":for(c=0;c<d.length;c++)(b=h(d[c]))&&f.appendChild(b);break;case"recreate":case"splice":for(c=0;c<a.removed.length;c++)(b=g(a.removed[c]))&&f.removeChild(b);for(c=0;c<d.length;c++)(b=h(d[c]))&&f.appendChild(b)}return d},rerender:function(){return this.processRendering({method:"rerender"})},hasOwnProperty:function(a){return"length"==a||a<this.length&&a>=0},toJSON:function(){var a,b=this,c=[];for(a=0;a<b.length;a++)c.push(b[a]&&b[a].toJSON?b[a].toJSON():b[a]);return c},concat:function(){var b,c,d,e=arguments,f=this.toArray();for(c=0;c<e.length;c++)if(b=e[c],b instanceof Array||b&&b.instanceOf&&b.instanceOf(a.Array))for(d=0;d<b.length;d++)f.push(b[c]);return(new a.Array).recreate(f)},pull:function(b,c){var f,g,h=this,j=h.toArray(),k=b,l=typeof b;return"number"==l||"string"==l||(b=h.indexOf(b),~b)?(f=j.splice(b,1)[0]||null,e(j,h)||(c=c||{},h.recreate(j,d),c=a.extend({returns:f,args:[k],
method:"pull",self:h,added:[],removed:g=f?[f]:[]},c),c.silent||(h._trigger("pull",c),h._trigger("remove",c),i(h,g),h._trigger("modify",c)),h.processRendering(c)),f):null},indexOf:f,lastIndexOf:g};return"push pop unshift shift sort reverse splice map filter slice every some reduce reduceRight forEach toString join".split(" ").forEach(function(a){k[a]=j(a)}),"push pop unshift shift sort reverse splice".split(" ").forEach(function(a){k[a+"_"]=j(a,1)}),k.each=k.forEach,k["undefined"!=typeof Symbol?Symbol.iterator:"@@iterator"]=function(){var a=this,b=0;return{next:function(){return b>a.length-1?{done:!0}:{done:!1,value:a[b++]}}}},a.Array=a.Class(k),a.Array.of=function(){var b,c=new a.Array,d=arguments;for(c.length=d.length,b=0;b<d.length;b++)c[b]=d[b];return c},a.Array.from=function(b,c,d){var e,f=new a.Array;for(f.length=b.length,e=0;e<b.length;e++)f[e]=c?c.call(d,b[e],e,b):b[e];return f},a.Array}),"function"==typeof define&&define.amd&&define("matreshka",["matreshka_dir/matreshka-core","matreshka_dir/matreshka-object","matreshka_dir/matreshka-array"],function(a,b,c,d){
return a}),"function"==typeof define&&define.amd?define(["matreshka"],function(a){return a.version="1.0.6",a}):(Matreshka.version="1.0.6","object"==typeof exports&&(module.exports=Matreshka));
